/*************************************************************************
* File:      I2C_master_drv.c  [derived from i2cmaster.c]
...
**************************************************************************/
#include "twi.h"  // file extracted from Atmel Studio IDE install folder
#include "I2C_master_drv.h"

/* define CPU frequency in MHz here if not defined elsewhere */
#ifndef F_CPU
...
{
    TWSR = 0;   /* no prescaler */
    TWBR = ((F_CPU / ((long)clock_freq_kHz * 1000) - 16)) / 2;
}
